 ...
 */
@Path("/buttons")
@View("templates/bootstrap/BootstrapButtonsPage.peb")
public class BootstrapButtonsPage extends Page {
    public BootstrapButtonsPage() {
        ...
        setComponent("ButtonEvents", new Composite<>(List.of(
                createButton("Click event", BsButton.Style.PRIMARY, event -> {
                    BsButton button = (BsButton) event.component();
                    button.setText("Clicked!");
                    button.setStyle(BsButton.Style.DANGER);
                    button.setSize(BsButton.Size.LARGE);
